...
final List<Animal> mockAnimals = [
  ...
  Animal(id: '8', tagId: 'C-008', species: Species.cow, breed: 'Sahiwal', dateOfBirth: DateTime(2021, 9, 7), gender: Gender.female, status: AnimalStatus.deceased, purpose: AnimalPurpose.dairy, weightKg: 410, heightCm: 132, color: 'Brown', shedNumber: 'A1', farmerId: 'F001', mortalityDate: DateTime(2026, 2, 10), mortalityReason: 'Pneumonia'),
  ...
  Animal(id: '15', tagId: 'G-002', species: Species.goat, breed: 'Boer', dateOfBirth: DateTime(2023, 6, 22), gender: Gender.male, status: AnimalStatus.active, purpose: AnimalPurpose.meat, weightKg: 55, heightCm: 75, color: 'Brown & White', shedNumber: 'E1', farmerId: 'F001', castrationDate: DateTime(2023, 9, 15)),
  ...
  Animal(id: '19', tagId: 'S-002', species: Species.sheep, breed: 'Nellore', dateOfBirth: DateTime(2023, 8, 14), gender: Gender.male, status: AnimalStatus.active, purpose: AnimalPurpose.meat, weightKg: 42, heightCm: 68, color: 'White-Brown', shedNumber: 'F1', farmerId: 'F001', castrationDate: DateTime(2024, 1, 20)),
  ...
  // ── Animals for other farms ──
  Animal(id: '25', tagId: 'W-001', species: Species.cow, breed: 'Holstein Friesian', dateOfBirth: DateTime(2020, 5, 10), gender: Gender.female, status: AnimalStatus.active, purpose: AnimalPurpose.dairy, weightKg: 520, heightCm: 142, color: 'Black & White', shedNumber: 'A1', farmerId: 'F002'),
  Animal(id: '26', tagId: 'W-002', species: Species.cow, breed: 'Jersey', dateOfBirth: DateTime(2021, 2, 18), gender: Gender.female, status: AnimalStatus.pregnant, purpose: AnimalPurpose.dairy, weightKg: 400, heightCm: 128, color: 'Fawn', shedNumber: 'A1', farmerId: 'F002'),
  Animal(id: '27', tagId: 'W-003', species: Species.buffalo, breed: 'Murrah', dateOfBirth: DateTime(2019, 8, 5), gender: Gender.female, status: AnimalStatus.active, purpose: AnimalPurpose.dairy, weightKg: 560, heightCm: 141, color: 'Black', shedNumber: 'B1', farmerId: 'F002'),
  Animal(id: '28', tagId: 'W-004', species: Species.cow, breed: 'Gir', dateOfBirth: DateTime(2022, 1, 15), gender: Gender.male, status: AnimalStatus.active, purpose: AnimalPurpose.breeding, weightKg: 490, heightCm: 138, color: 'Dark Red', shedNumber: 'B2', farmerId: 'F002'),
  Animal(id: '29', tagId: 'J-001', species: Species.goat, breed: 'Jamunapari', dateOfBirth: DateTime(2023, 3, 20), gender: Gender.female, status: AnimalStatus.active, purpose: AnimalPurpose.dairy, weightKg: 42, heightCm: 78, color: 'White', shedNumber: 'C1', farmerId: 'F003'),
  Animal(id: '30', tagId: 'J-002', species: Species.goat, breed: 'Boer', dateOfBirth: DateTime(2023, 7, 12), gender: Gender.male, status: AnimalStatus.active, purpose: AnimalPurpose.meat, weightKg: 52, heightCm: 74, color: 'Brown & White', shedNumber: 'C1', farmerId: 'F003'),
  Animal(id: '31', tagId: 'J-003', species: Species.goat, breed: 'Sirohi', dateOfBirth: DateTime(2022, 9, 8), gender: Gender.female, status: AnimalStatus.pregnant, purpose: AnimalPurpose.mixed, weightKg: 38, heightCm: 71, color: 'Brown', shedNumber: 'C2', farmerId: 'F003'),
  Animal(id: '32', tagId: 'BR-001', species: Species.cow, breed: 'Red Sindhi', dateOfBirth: DateTime(2021, 4, 22), gender: Gender.female, status: AnimalStatus.active, purpose: AnimalPurpose.dairy, weightKg: 380, heightCm: 122, color: 'Red', shedNumber: 'A1', farmerId: 'F004'),
  Animal(id: '33', tagId: 'BR-002', species: Species.cow, breed: 'Tharparkar', dateOfBirth: DateTime(2020, 12, 3), gender: Gender.female, status: AnimalStatus.sick, purpose: AnimalPurpose.dairy, weightKg: 430, heightCm: 130, color: 'White', shedNumber: 'A2', farmerId: 'F004'),
  Animal(id: '34', tagId: 'BR-003', species: Species.buffalo, breed: 'Surti', dateOfBirth: DateTime(2022, 6, 15), gender: Gender.female, status: AnimalStatus.active, purpose: AnimalPurpose.dairy, weightKg: 500, heightCm: 136, color: 'Brown-Black', shedNumber: 'B1', farmerId: 'F004'),
];
