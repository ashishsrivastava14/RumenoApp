...
final List<ExpenseRecord> mockExpenses = [
  ...
  ExpenseRecord(id: 'EXP004', category: ExpenseCategory.veterinary, subCategory: 'Consultation', amount: 1500, date: DateTime(2026, 2, 18), vendorName: 'Dr. Emily Thompson', paymentMode: PaymentMode.upi, farmerId: 'F001'),
  ExpenseRecord(id: 'EXP005', category: ExpenseCategory.labour, subCategory: 'Farm Hand', amount: 15000, date: DateTime(2026, 2, 1), vendorName: 'Mark Evans', paymentMode: PaymentMode.bank, notes: 'Monthly salary', farmerId: 'F001'),
  ExpenseRecord(id: 'EXP006', category: ExpenseCategory.labour, subCategory: 'Farm Hand', amount: 12000, date: DateTime(2026, 2, 1), vendorName: 'Richard Moore', paymentMode: PaymentMode.cash, notes: 'Monthly salary', farmerId: 'F001'),
  ...
  ExpenseRecord(id: 'EXP016', category: ExpenseCategory.labour, subCategory: 'Farm Hand', amount: 15000, date: DateTime(2026, 1, 1), vendorName: 'Mark Evans', paymentMode: PaymentMode.bank, farmerId: 'F001'),
  ExpenseRecord(id: 'EXP017', category: ExpenseCategory.labour, subCategory: 'Farm Hand', amount: 12000, date: DateTime(2026, 1, 1), vendorName: 'Richard Moore', paymentMode: PaymentMode.cash, farmerId: 'F001'),
  ...
  ExpenseRecord(id: 'EXP019', category: ExpenseCategory.veterinary, subCategory: 'Health Checkup', amount: 2000, date: DateTime(2026, 1, 10), vendorName: 'Dr. Emily Thompson', paymentMode: PaymentMode.upi, farmerId: 'F001'),
  ...
  ExpenseRecord(id: 'EXP030', category: ExpenseCategory.veterinary, subCategory: 'Surgery', amount: 5000, date: DateTime(2025, 10, 5), vendorName: 'Dr. Emily Thompson', paymentMode: PaymentMode.upi, animalId: '9', notes: 'Minor hoof surgery', farmerId: 'F001'),
];
